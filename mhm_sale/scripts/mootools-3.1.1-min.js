...
}return this;},unpin:function(){return this.pin(false);},togglePin:function(){return this.pin(!this.retrieve("pin:_pinned"));}});}).call(this);(function(){var a=Element.prototype.position;
...
}}}.bind(this));return c?this.start(h):this.set(h);}});Fx.Move=new Class({Extends:Fx.Morph,options:{relativeTo:document.body,position:"center",edge:false,offset:{x:0,y:0}},start:function(a){var b=this.element,c=b.getStyles("top","left");
...
b.inherits.sets=d.inherits.sets||{};}return b;};}).call(this);